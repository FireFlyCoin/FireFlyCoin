...
// Copyright (c) 2013 FireFlyCoin developers
...
const string strMessageMagic = "FireFlyCoin Signed Message:\n";
...
static const int64 nStartSubsidy = 120 * COIN;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("FireFlyCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("FireFlyCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("FireFlyCoinMiner started\n");
    ...
    try { loop {
        ...
        printf("Running FireFlyCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("FireFlyCoinMiner terminated\n");
        throw;
    }
}
